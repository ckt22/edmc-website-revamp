...
export default function ProjectsCard({ title, description, tags = [], viewPageLink } : { title: string, description: string, tags?: Array<string>, viewPageLink: string }) {
    ...
    return (
        <div className={styles.projectsCardContainer}>
            ...
            <div className={styles.projectsCardButtonContainer}>
                ...
                {tags.map((t, idx) => (<div className={styles.cardButton} key={idx}>{t}</div>))}
